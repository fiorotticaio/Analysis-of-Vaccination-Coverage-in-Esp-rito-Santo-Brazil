...
from plots_es import plot_vaccination_coverage_es, plot_coverage_es_cities_es
...
plot_coverage_es_cities_es('2021')
plot_coverage_es_cities_es('2022')
plot_coverage_es_cities_es('2023')
